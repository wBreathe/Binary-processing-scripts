...
def get_nx_graph(flowchart, ignore_external=False):
    ...
    for block in flowchart:
        ...
        #assert(block.preds() is not None) # not working
...
def indirect_execute():
    ...
    #print(dir_file)
    cur_dir = os.getcwd()
    root_dir = cur_dir.replace("binary","new_temp_data")+"/"+dir_file+"/"
    dir = {}
    ...
    for func_addr in Functions():
        ...
        if func_addr != BADADDR:
            ...
            if func_name in indtemp.keys():
                ...
                func_head_branch = combine_branch_sequence(func_head,f,func_name,func_blocks,func_boundary,0)
